...
export function Card({
  ...
  const defaultProps = {
    className: cn(
      'relative flex flex-col rounded-2xl border border-neutral-200 bg-neutral-50 text-neutral-950 not-dark:bg-clip-padding dark:border-neutral-800 dark:bg-neutral-950 dark:text-white',
      className
    ),
    'data-slot': 'card'
  };
...
export function CardFrame({
  ...
  const defaultProps = {
    className: cn(
      'relative flex flex-col rounded-2xl border border-neutral-200 bg-white text-neutral-950 [--clip-bottom:-1rem] [--clip-top:-1rem] not-dark:bg-clip-padding *:data-[slot=card]:-m-px *:data-[slot=card]:bg-clip-padding *:data-[slot=card]:shadow-none *:data-[slot=card]:[clip-path:inset(var(--clip-top)_1px_var(--clip-bottom)_1px_round_calc(var(--radius-2xl)-1px))] *:not-first:data-[slot=card]:rounded-t-xl *:not-last:data-[slot=card]:rounded-b-xl *:data-[slot=card]:first:[--clip-top:1px] *:data-[slot=card]:last:[--clip-bottom:1px] dark:border-neutral-700 dark:bg-neutral-950 dark:text-white',
      className
    ),
...
export function CardFrameTitle({
  ...
  const defaultProps = {
    className: cn('text-sm font-semibold text-neutral-950 dark:text-white', className),
...
export function CardTitle({
  ...
  const defaultProps = {
    className: cn('text-lg leading-none font-semibold text-neutral-950 dark:text-white', className),
