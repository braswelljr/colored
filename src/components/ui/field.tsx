  ...
  return (
    <Label
      ...
      className={cn(
        ...
        'has-data-[state=checked]:border-neutral-900 has-data-[state=checked]:bg-neutral-900/5 dark:has-data-[state=checked]:border-neutral-50 dark:dark:has-data-[state=checked]:bg-neutral-50/10 dark:has-data-[state=checked]:bg-neutral-900/10',
        className
      )}
      {...props}
    />
